angular.module('starter.controllers', ['ionic'])
  ...
  .controller('DashCtrl', function($scope, $http, $state) {
          $scope.$on('$ionicView.enter', function(e) {
            ...
            $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
            $http.post(
                accountantURL + '/auery/generalstat/',
                'token=' + token
              )
              .success(function(data) {
              ...
              .error(function() {
                $scope.message = 'erorr reading from accountant stats' //TODO: show some error to user
          ...
          $scope.submitExpenseModal = function() {
            ...
            $http.post(
              ...
              .success(function(data) {
                ...
                $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
                $http.post(accountantURL + '/query/expenses/', 'token='+token).success(function(data) {
          ...
          $scope.submitIncomeModal = function() {
            ...
            $http.post(
              ...
              .success(function(data) {
                ...
                // update the expenses part, containing the new one
                $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
                $http.post(accountantURL + '/query/incomes/', 'token='+token).success(function(data) {
          ...
          $scope.submit = function() {
            ...
            $http.post(
              ...
              .success(function(data) {
                ...
                $http.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded;charset=utf-8';
                $http.post(accountantURL + '/q/incomes/', 'token='+token).success(function(data) {
                    $scope.incomes = JSON.parse(data);
                  }).error(function() {
                    $scope.message = 'erorr reading previous incomes' //TODO: show some error to user       console.log('error on request')
                })
